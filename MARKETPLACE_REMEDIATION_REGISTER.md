...
| TXN-011 | Recurring/per-occurrence escrow model not implemented | Transactions/Payments | P2 | Not started |
| TXN-012 | Milestone payment structure (`docs/07`'s >KSh 25k rule) not implemented | Transactions/Payments | P2 | Not started |
...
- **Complexity:** Large.
- **Status:** Not started. Requires business decision (is this in Phase 1 scope?).
