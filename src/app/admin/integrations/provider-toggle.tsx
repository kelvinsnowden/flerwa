...
import { setActivePaymentProvider, setActivePayoutProvider, setActiveVerificationProvider, setActiveNotificationChannel } from "./actions";
...
export function ProviderToggleList({ kind, rows }: { kind: "payment" | "payout" | "verification" | "notification"; rows: Row[] }) {
