  ...
  return (
    <div>
      ...
      <p className="text-sm text-[var(--muted)] mb-4">
        Providers submit jobs they already arranged with a customer directly.
        Converting one requires the customer to already have an account —
        look them up by the phone or email they gave the provider.
      </p>
      ...
      <div className="flex flex-col gap-4">
        {requests?.map((r) => (
          <DealDeskCard
            ...
            request={{
              id: r.id,
              providerName: r.providers?.display_name ?? "Provider",
